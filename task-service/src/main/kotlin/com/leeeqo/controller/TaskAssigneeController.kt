...
class TaskAssigneeController(
    ...
    fun getAllTasksByAssignee(@PathVariable("assigneeId") assigneeId: Long): ResponseEntity<List<TaskResponse>> =
        ResponseEntity.ok(taskAssigneeService.getAllByAssigneeId(assigneeId))
